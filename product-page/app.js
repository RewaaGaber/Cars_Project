...
function addItem() {
    if (amountValue >= 0) {
        const total = 35000 * amountValue;
    wrp.classList.remove("empty");
    wrp.innerHTML = `<div class="product">
                    <div>
                      <img src="./images/image-1-thumbnail.jpg" class="product-img" alt="product">
                      <div class="product-info">
                        <p class="product-title">Urus Model</p>
                       <p><span>$35000.00</span> × <span class="number">${1}</span> <b>$${total}</b></p>
                      </div>
                      <button class="delete-btn" onclick="deleteItem()"><img src="./images/icon-delete.svg" alt="delete"></button>
                    </div>
                    <a href="../off-payment/index.html" class="checkout-btn">Checkout</a>
                  </div>`;
...
images.forEach((image) => {
  image.addEventListener("click", () => {
    ...
    switch (selectedImg.getAttribute("src")) {
      case "./images/image-1-thumbnail.jpg":
        mainThumbnail.src = "./images/image-1.jpg";
        mainThumbnailLightBox.src = "./images/image-1.jpg";
        break;
      case "./images/image-2-thumbnail.jpg":
        mainThumbnail.src = "./images/image-2.jpg";
        mainThumbnailLightBox.src = "./images/image-2.jpg";
        break;
      case "./images/image-3-thumbnail.jpg":
        mainThumbnail.src = "./images/image-3.jpg";
        mainThumbnailLightBox.src = "./images/image-3.jpg";
        break;
      case "./images/image-4-thumbnail.jpg":
        mainThumbnail.src = "./images/image-4.jpg";
        mainThumbnailLightBox.src = "./images/image-4.jpg";
        break;
    }
  });
});
